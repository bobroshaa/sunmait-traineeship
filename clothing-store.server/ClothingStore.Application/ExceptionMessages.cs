...
public static class ExceptionMessages
{
    ...
    public static readonly string ProductQuantityIsNotAvailable =
        "Quantity {0} of product with id {1} is not available. Available quantity {2}.";
    ...
    public static readonly string SectionCategoryNotFound =
        "The relation with id {0} between category and section does not exist.";
    ...
    public static readonly string IncorrectInStockQuantity =
        "Unable to set in-stock quantity to {0} for product with id{1}. The reserved quantity {2} exceeds the new in-stock quantity.";
}